...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/cdmm/Library/Application Support/luaglider2/dev";local SOCKET_PORT=36532;local GLIDER_MAIN_FOLDER= "/Users/cdmm/Desktop/OneDrive/Documents/UROP/MathApp/sbs_math";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
